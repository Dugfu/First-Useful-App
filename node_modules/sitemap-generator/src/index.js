...
module.exports = function SitemapGenerator(uri, opts) {
  ...
  crawler.on('fetch404', (queueItem) => emitError(queueItem));
  crawler.on('fetchtimeout', (queuItem) => emitError(queItem));
  crawler.on('fetch410', (queueItem) => emitError(queueItem));
